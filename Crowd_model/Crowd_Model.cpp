...
/*           Формирование списка файлов моделей в разделе            */
 ...
 CROWD_MODEL_API int  Crowd_Model_list(char *lib_path, 
...
/*                  Считывание параметров модели                     */ 
 ...
 CROWD_MODEL_API int  Crowd_Model_ReadPars(Crowd_Model_data *data)
...
/*               Считывание секций описаний модели                   */ 
 ...
 CROWD_MODEL_API int  Crowd_Model_ReadSect(Crowd_Model_data *data)
...
/*                  Считывание картинки модели                       */ 
 ...
 CROWD_MODEL_API int  Crowd_Model_Picture(Crowd_Model_data *data, 
                                                   HBITMAP *hBitmap,
                                                      RECT *Frame  )
