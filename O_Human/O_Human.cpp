     ...
     int  Crowd_Object_Human::iBehaviorDog(long  t, char *event_type, void *event_data, Crowd_Kernel *task)
{
  ...
  static  struct Profile  profile[]={
            ...
            { "recovery",  "Восстановление", "Коэффициент повышения 'энергичности' за пассивный цикл",       "Digital", 0.,   1.0, NULL, NULL },
            { "" } 
                                    } ; 
     ...
     int  Crowd_Object_Human::iBehaviorSpectr(long  t, char *event_type, void *event_data, Crowd_Kernel *task)
{
  ...
  static  struct Profile  profile[]={
            ...
            { "sense1",   "Чувствительность 1", "Чувствительность к компоненту спектра 1",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "sense2",   "Чувствительность 2", "Чувствительность к компоненту спектра 2",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "sense3",   "Чувствительность 3", "Чувствительность к компоненту спектра 3",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "sense4",   "Чувствительность 4", "Чувствительность к компоненту спектра 4",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "sense5",   "Чувствительность 5", "Чувствительность к компоненту спектра 5",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "sense6",   "Чувствительность 6", "Чувствительность к компоненту спектра 6",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "sense7",   "Чувствительность 7", "Чувствительность к компоненту спектра 7",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "sense8",   "Чувствительность 8", "Чувствительность к компоненту спектра 8",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "sense9",   "Чувствительность 9", "Чувствительность к компоненту спектра 9",                        "Digital", -1.0,       1.0, NULL, NULL },
            { "" } 
                                    } ; 
